...
def show_help():
    console.print(Panel(
        Text.assemble(
            ...
            ("  23     ", "bold cyan"), ("Update / Uninstall pentools\n", "white"),
...
_BANNER_ART = [
    r" _______     ______  ______ _____  ",
    r" / ____\ \   / /  _ \|  ____|  __ \ ",
    r"| |     \ \_/ /| |_) | |__  | |__) |",
    r"| |      \   / |  _ <|  __| |  _  / ",
    r"| |____   | |  | |_) | |____| | \ \ ",
    r" \_____|  |_|  |____/|______|_|  \_\ ",
    r"                                      ",
    r"                                      ",
    r" _____  ______ _   _ _______ ____   ____  _       _____ ",
    r"|  __ \|  ____| \ | |__   __/ __ \ / __ \| |     / ____|",
    r"| |__) | |__  |  \| |  | | | |  | | |  | | |    | (___  ",
    r"|  ___/|  __| | . ` |  | | | |  | | |  | | |     \___ \ ",
    r"| |    | |____| |\  |  | | | |__| | |__| | |____ ____) |",
    r"|_|    |______|_| \_|  |_|  \____/ \____/|______|_____/ ",
    r"                                                          ",
    r"                                                          ",
]
...
def main():
    try:
        ...
        get_tools_dir()   # ensures ~/.pentools/tools/ exists
        interact_menu()
